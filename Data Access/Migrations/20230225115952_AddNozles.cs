...
{
    /// <inheritdoc />
    public partial class AddNozles : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    P6 = table.Column<double>(type: "float", nullable: false),
                    readingNo = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nozles", x => x.Id);
                });
        }
